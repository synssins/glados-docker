...
("Cindy's office"), default color temperature and brightness targets,
...
class UserPreferences(BaseModel):
    ...
    area_aliases: dict[str, str] = Field(
        ...
        description=(
            ...
            "{'cindys office': 'cindy_office', 'the workshop': 'garage'}. "
    ...
    def _normalize_aliases(cls, v: dict[str, str]) -> dict[str, str]:
        """Lowercase keys and strip whitespace so a 'Cindy's Office'

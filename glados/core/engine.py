...
class Glados:
    ...
    def play_announcement(self, interruptible: bool | None = None) -> None:
        ...
        if wav_files:
            ...
            try:
                import httpx
                ha_url = getattr(self.audio_io, "ha_url", "http://192.168.1.104:8123")
                ha_token = getattr(self.audio_io, "ha_token", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiI0NDA0NjU3OGExMTc0YTBlYmQ5MjVmOWNmMDYxMzQ4MiIsImlhdCI6MTc3MTkwNTM0NiwiZXhwIjoyMDg3MjY1MzQ2fQ.3G-9ZnTP61XRXoEXfwi4aqrp4PBzybFdyFalJPFNFG8")
                serve_host = getattr(self.audio_io, "serve_host", "192.168.1.75")
                ...
                entities = override or getattr(self.audio_io, "media_player_entities", ["media_player.living_room_2"])

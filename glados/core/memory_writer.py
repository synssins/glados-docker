...
def detect_explicit_memory(message: str) -> str | None:
    ...
    Examples:
        "Remember that I prefer the bedroom at 68 degrees"
          → "Chris prefers the bedroom at 68 degrees"
        "Note that Frito is not allowed in the office"
          → "Frito is not allowed in the office"
    """
    ...
    try:
        ...
        extract_response = llm_call(
            ...
            system_prompt=(
                ...
                "clear sentence in third person (e.g. 'Chris prefers...' not 'I prefer...'). "

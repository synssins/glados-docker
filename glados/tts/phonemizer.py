...
class Phonemizer:
    ...
    def __init__(self, config: ModelConfig | None = None) -> None:
        ...
        # Add common contractions — the ONNX predictor gets these wrong
        # because the apostrophe was historically stripped during text cleaning.
        ...
        # Override heteronyms and fix mispronounced words.
        # "conduct"/"conducts" default to noun stress (CON-duct) in the dict;
        # GLaDOS almost always uses the verb form (con-DUCT).
        self.phoneme_dict.update({
            "conduct": "kəndˈʌkt",
            "conducts": "kəndˈʌkts",
        })

        # Words the built-in dictionary or ONNX predictor gets wrong.
        self.phoneme_dict.update({
            "area": "ˈɛɹiːə",
            "areas": "ˈɛɹiːəz",
            "gertrude": "ɡˈɝːtɹuːd",
        ...
        # Compound and invented words the ONNX predictor rushes or mangles.
        self.phoneme_dict.update({
            "fluffybutt": "flˈʌfi bˈʌt",
            "cuddlewumps": "kˈʌdəl wˈʌmps",

...
class InfoFetcher:
    ...
    Args:
        ...
        ha_url: Home Assistant base URL (e.g. ``http://192.168.1.104:8123``).
    ...
    def __init__(
        ...
        ha_url: str = "http://192.168.1.104:8123",
        ha_token: str = "",
        ...
        self._home_entities = home_entities or [
            ...
            ("cover.garage_door_1", "closed"),
            ("lock.yale_smart_lock_with_matter", "locked"),
            ("binary_sensor.front_door_contact_sensor_contact", "off"),
            ("binary_sensor.back_door_contact_sensor_contact", "off"),
        ]

...
def _draw_home_status(
    ...
    entities: list[tuple[str, str, str]] = [
        ("cover.vehicle_door", "G1", "closed"),
        ("cover.vehicle_door_two", "G2", "closed"),
        ("lock.entry_lock", "LK", "locked"),
        ("binary_sensor.entry_door_contact", "FD", "off"),
        ("binary_sensor.back_entry_contact", "BD", "off"),
    ]

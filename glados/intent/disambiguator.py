...
class Disambiguator:
    ...
    def run(self, utterance: str, source: str) -> DisambiguationResult:
        ...
        #     "Ambiguity detected: binary_sensor.sm_n986u1_is_charging,
        #      sensor.alan_t_state_2. Specify which Alan you mean."
    ...
    def _build_prompt(
        ...
        sys = (
            ...
            "      area (e.g. scene.living_room_scene_reading)\n"
...
def _speech_leaks_entity_ids(
    ...
    candidate list. Entity IDs (`light.bedroom_ceiling`,
    `sensor.alan_t_state_2`, …) are developer-format strings and must

...
class TestOllamaChatUrl:
    ...
    def test_ipv4_host(self) -> None:
        assert _ollama_chat_url("http://192.168.1.75:11436") == "http://192.168.1.75:11436/api/chat"
...
class TestSyncRewrites:
    ...
    def _fake_glados_config(self) -> dict:
        return {
            "Glados": {
                ...
                "completion_url": "http://192.168.1.75:11434/api/chat",
                "autonomy": {
                    "enabled": True,
                    "completion_url": "http://192.168.1.75:11434/api/chat",
                    "llm_model": "qwen2.5:14b-instruct-q4_K_M",
    ...
    def test_interactive_change_rewrites_chat_url(self) -> None:
        ...
        self._apply_sync(cfg, {
            "ollama_interactive": {"url": "http://192.168.1.75:11436"},
        })
        assert cfg["Glados"]["completion_url"] == "http://192.168.1.75:11436/api/chat"

...
Points at real LAN services (AIBox = 10.0.0.10 for Ollama/speaches,
HA = 10.0.0.20) so the UI loads real entity data. Writes to
...
os.environ.setdefault("OLLAMA_URL", "http://10.0.0.10:11434")
os.environ.setdefault("OLLAMA_AUTONOMY_URL", "http://10.0.0.10:11436")
os.environ.setdefault("OLLAMA_VISION_URL", "http://10.0.0.10:11435")
os.environ.setdefault("SPEACHES_URL", "http://10.0.0.10:5050")
os.environ.setdefault("VISION_URL", "http://10.0.0.10:8016")
os.environ.setdefault("HA_URL", "http://10.0.0.20:8123")
os.environ.setdefault("HA_WS_URL", "ws://10.0.0.20:8123/api/websocket")
